...
genres = [
    ...
    {"label": "Genre", "name": "Romance"},
    {"label": "Genre", "name": "Sci-Fi"},
...
def main():
    ...
    try:
        ...
        relationships = [
            ...
            ("Andrew Garfield", "La La Land", "Supporting"),
            ("Tom Cruise", "Top Gun: Maverick", "Principal"),
            ("Margot Robbie", "Top Gun: Maverick", "Supporting")
        ]

        for actor, movie, role in relationships:
